...
import com.example.StudentExamManagementSystem.security.jwt.JwtUtils;
import com.example.StudentExamManagementSystem.security.request.LoginRequest;
import com.example.StudentExamManagementSystem.security.request.SignupRequest;
import com.example.StudentExamManagementSystem.security.response.MessageResponse;
import com.example.StudentExamManagementSystem.security.response.UserInfoResponse;
import com.example.StudentExamManagementSystem.security.services.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        // Create new user's account
        User user = new User(signUpRequest.getFirstName(), signUpRequest.getUserName(), signUpRequest.getLastName(), signUpRequest.getEmail(), signUpRequest.getDob(), signUpRequest.getHireDate(), signUpRequest.getRegistrationDate(), encoder.encode(signUpRequest.getPassword()));
